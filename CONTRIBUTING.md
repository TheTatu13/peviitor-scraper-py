...
Open a [GitHub Issue](https://github.com/TheTatu13/peviitor-scraper-py/issues) with:
...
(`https://www.antibiotice.ro/cariere/open-position/`) and its job sitemap (`https://www.antibiotice.ro/joburi-sitemap.xml`).
