...
Fill this in per derived company. Check `https://www.antibiotice.ro/robots.txt` before the
...
| Path | Role |
|---|---|
| `https://www.antibiotice.ro/cariere/open-position/` | Public list of open positions (server-rendered HTML) |
| `https://www.antibiotice.ro/joburi-sitemap.xml` | Job sitemap — canonical `https://www.antibiotice.ro/joburi/<slug>/` permalinks |
| `https://www.antibiotice.ro/joburi/<slug>/` | Individual job pages (only referenced, not fully crawled) |
