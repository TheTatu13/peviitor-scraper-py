...
Acest proiect folosește [GitHub Issues](https://github.com/TheTatu13/peviitor-scraper-py/issues) pentru a urmări munca.
...
Vezi [toate issue-urile](https://github.com/TheTatu13/peviitor-scraper-py/issues).
